 ...
 */
public class KSyntaxStubElementType extends ILightStubElementType<IKSyntaxStub, KSyntax> {
    ...
    @Override
    public IKSyntaxStub createStub(LighterAST tree, LighterASTNode node, StubElement parentStub) {
    ...
    @Override
    public KSyntax createPsi(@NotNull IKSyntaxStub kSyntaxStub) {
        return new KSyntaxImpl(kSyntaxStub, this);
    }

    @NotNull
    @Override
    public IKSyntaxStub createStub(@NotNull KSyntax kSyntax, StubElement stubElement) {
        return new KSyntaxStubImpl(stubElement, kSyntax.getName());
    }
    ...
    @Override
    public void serialize(@NotNull IKSyntaxStub stub, @NotNull StubOutputStream stubOutputStream)
            throws IOException {
    ...
    @NotNull
    @Override
    public IKSyntaxStub deserialize(@NotNull StubInputStream stubInputStream, StubElement parentStub)
            throws IOException {
    ...
    @Override
    public void indexStub(@NotNull IKSyntaxStub stub, @NotNull IndexSink indexSink) {
